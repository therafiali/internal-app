              ...
              <>
                ...
                <div className="bg-[#1a1a1a] rounded overflow-hidden">
                  <div className="overflow-x-auto">
                    <table className="w-full">
                      <thead>
                        <tr className="border-b border-white/5 bg-/20 text-xs text-gray-400">
                          ...
                          redeemRequests.map((request) => (
                            ...
                            >
                              ...
                              <td className="px-4 py-2.5">
                                <span className="bg-blue-/10 text-white-400 px-2 py-0.5 rounded text-xs te">
                                  {request.gamePlatform}
                                </span>
                              </td>
