-- First, update the redeem_status enum to include verification_pending
ALTER TYPE redeem_status ADD VALUE IF NOT EXISTS 'verification_pending';
...
-- Drop and recreate the function with updated status handling
